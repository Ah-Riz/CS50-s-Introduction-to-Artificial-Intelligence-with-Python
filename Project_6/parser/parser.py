...
NP -> N | Det N | Det Adj N | N P NP | NP Conj NP | Det N P NP | Det Adj N P NP
VP -> V | V NP | V P NP | V Adv | Adv VP | VP Adv | VP P NP
"""
...
def preprocess(sentence):
    ...
    res_token = [word.lower() for word in token if word.isalpha()]
    return res_token
